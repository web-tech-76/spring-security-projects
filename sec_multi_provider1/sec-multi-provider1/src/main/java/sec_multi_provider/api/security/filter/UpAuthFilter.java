package sec_multi_provider.api.security.filter;
...
import sec_multi_provider.api.repository.OtpRepository;
import sec_multi_provider.api.security.authentications.OtpAuthentication;
...
public class UpAuthFilter extends OncePerRequestFilter {
    ...
    public UpAuthFilter(AuthenticationManager authenticationManager, @Lazy OtpRepository otpRepository) {
